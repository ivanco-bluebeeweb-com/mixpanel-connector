"""Settings panel for Mixpanel Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__mixpanel_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=mixpanel_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_mixpanel"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Mixpanel Settings & Accounts", level=2),
